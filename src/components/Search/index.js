    ...
    return uniquePairs
      ? uniquePairs
          .sort((a, b) => {
            ...
            if (pairA?.trackedReserveKCS && pairB?.trackedReserveKCS) {
              return parseFloat(pairA.trackedReserveKCS) > parseFloat(pairB.trackedReserveKCS) ? -1 : 1
            }
            if (pairA?.trackedReserveKCS && !pairB?.trackedReserveKCS) {
              return -1
            }
        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search KsfSwap pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
