          ...
          <DataText area="return">
            <AutoColumn gap="12px" justify="flex-end">
              ...
              <AutoColumn gap="4px" justify="flex-end">
                <RowFixed>
                  <TYPE.small fontWeight={400}>
                    {parseFloat(position.pair.token0.derivedKCS)
                      ? formattedNum(
                          position?.fees.sum / (parseFloat(position.pair.token0.derivedKCS) * kcsPrice) / 2,
                          false,
                          true
                        )
                      : 0}{' '}
                ...
                <RowFixed>
                  <TYPE.small fontWeight={400}>
                    {parseFloat(position.pair.token1.derivedKCS)
                      ? formattedNum(
                          position?.fees.sum / (parseFloat(position.pair.token1.derivedKCS) * kcsPrice) / 2,
                          false,
                          true
                        )
                      : 0}{' '}
